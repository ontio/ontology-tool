...
func RegisterGlobalParam() {
	...
	core.OntTool.RegMethod("GetGlobalParamContractParam", GetGlobalParamContractParam)
	core.OntTool.RegMethod("SetGlobalParamContractParam", SetGlobalParamContractParam)
}
